      ...
      compliance: {
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              '<strong>La infraestructura corre en una cuenta en la nube que es tuya, no nuestra. El repositorio está a tu nombre desde el primer día.</strong> No alojamos tu asistente de nuestro lado para darte luego un usuario. Con una excepción que conviene nombrar, porque si no la página se contradice con su propio ejemplo. <strong>Wazzy es producto nuestro y sí está alojado por nosotros</strong>, con su contrato de encargo y su aislamiento entre clínicas. Por eso aparece en esta página como banco de pruebas de nuestras prácticas y no como ejemplo de esta arquitectura. Lo que construimos para un cliente corre en la cuenta del cliente. Es poco habitual en el sector y es deliberado, porque elimina toda una familia de preguntas que tu DPD tendría que perseguir. No hay una base de datos de proveedor con una copia de tus registros ni una negociación de salida si dejamos de trabajar juntos. Hay algo que sí conviene decir y que casi ningún proveedor dice de sí mismo. <strong>Nosotros también somos encargados del tratamiento.</strong> Operamos el sistema, así que accedemos a datos personales y hace falta un contrato de encargo con nosotros, igual que con cualquier otro proveedor de la cadena. El sistema se queda donde siempre estuvo, con su documentación y su historia.',
              'De la cuenta salen dos caminos y los dos hay que mapearlos. El primero es la llamada al proveedor del modelo, la empresa que ejecuta el modelo de lenguaje. Tú apruebas qué proveedor, bajo qué contrato y con qué configuración. Apruebas qué puede viajar dentro de esas llamadas. El segundo aparece cuando el asistente vive en un canal de mensajería. Si la conversación entra por WhatsApp o por Telegram, ese canal recibe el contenido íntegro y es un tercero más de la cadena, con su propio contrato y su propia valoración de transferencias. Un asistente web o interno no tiene esa segunda salida. Los proveedores de modelos firman contratos de encargo del tratamiento, que obligan a un proveedor a tratar datos solo según tus instrucciones. Los serios ofrecen regiones de procesamiento europeas. Si una configuración concreta satisface las reglas de transferencias internacionales es una valoración de tus abogados. Lo nuestro es entregarles un mapa completo de qué fluye a dónde, para que esa valoración lleve días en vez de meses.',
