    ...
    pages: {
      ...
      compliance: {
        ...
        hero: {
          ...
          title: 'IA conforme al RGPD, en una cuenta que es tuya',
          subtitle:
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              ...
              'Hay una excepción y conviene nombrarla, porque si no esta página se contradice con su propio ejemplo. <strong>Wazzy es producto nuestro y sí lo alojamos nosotros</strong>, con su contrato de encargo y su separación entre clínicas. Por eso aparece aquí como el sitio donde probamos nuestras prácticas, no como ejemplo de esta arquitectura. Lo que construimos para un cliente corre en la cuenta del cliente.',
