        ...
        sections: [
          {
            ...
            paragraphs: [
              ...
              'Ahí está la diferencia con un bot. Y no es que uno hable y el otro actúe, porque los asistentes de uso general también ejecutan acciones desde hace tiempo. <strong>La diferencia es quién decide la respuesta.</strong> La de un bot estaba escrita antes de que nadie preguntara. La de un agente se construye al preguntar.',
          ...
          },
          {
            ...
            bullets: [
              ...
              'Que planifica. Recibe un objetivo y monta él mismo la secuencia de pasos. La rehace si algo se tuerce. Le pides un presupuesto y consulta el catálogo, comprueba existencias y pide una excepción cuando falta una pieza. <strong>Aquí entra casi todo lo que hoy se vende como agente de IA, los nuestros incluidos.</strong> Cuesta más de levantar y menos de ampliar.',
          ...
          },
          {
            ...
            part: 'Tipos y usos',
            paragraphs: [
              'El tipo de agente de inteligencia artificial que «aprende» merece un aviso aparte, porque «aprende de tus datos» es de las frases más repetidas del sector y casi nunca significa lo que parece. <strong>Un agente en producción no mejora solo.</strong> Mejora cuando una persona cambia sus instrucciones, ordena mejor los datos o añade casos a la batería de pruebas. Ese cambio lo ejecuta siempre alguien.',
          ...
          },
          {
            ...
            paragraphs: [
              ...
              'Verás que en todos se repite lo mismo. Hay un texto que alguien tenía que leer y un dato o un sistema de la empresa al otro lado. <strong>Cuando falta una de esas dos mitades, casi siempre existe una manera más barata de resolverlo que un agente.</strong>',
            ],
            bullets: [
          ...
          },
          {
            ...
            part: 'Lo que puede salir mal',
            paragraphs: [
              'Hay un riesgo que casi nadie presupuesta. <strong>Un sistema con IA puede empeorar solo, sin que nadie lo toque.</strong> El proveedor actualiza el modelo sin cambiarle el nombre, tu documentación crece y tus datos van cambiando con el tiempo. <a class="link-inline" href="https://arxiv.org/abs/2307.09009" rel="noopener noreferrer" target="_blank">Chen, Zaharia y Zou</a>, de Stanford y Berkeley, lo midieron sobre el mismo modelo comercial en marzo y en junio de 2023. Su comportamiento cambió tanto que en una tarea el acierto pasó del 97,6 % al 2,4 %, sin que nadie del lado del cliente tocara nada. Gartner calculó en junio de 2025 que más del 40 % de los proyectos de IA agéntica se cancelará antes de acabar 2027. Por nuestra experiencia esa mortalidad vive en el mantenimiento y no en el estreno.',
              ...
              'Ninguna de estas cifras aparece sola. Existen porque el sistema se construyó desde el principio para medirse, con su batería y su vigilancia dentro del presupuesto. <strong>Cuando evalúes a cualquier proveedor, nosotros incluidos, pide las suyas.</strong> Lo que hace falta para que un sistema pase de su sexto mes tiene artículo propio.',
            ],
          ...
          },
          {
            ...
            bullets: [
              ...
              'Ocurre a menudo. Un flujo que corre tres veces al mes no llega a pagar la vigilancia que exige, por bien construido que esté. Por debajo de esa frecuencia la respuesta honesta casi siempre es que no.',
            ],
          },
          {
      ...
      conversational: {
        ...
        sections: [
          ...
          },
          {
            ...
            part: 'Decidir con criterio',
            paragraphs: [
              '<strong>Un agente conversacional no se lanza al mundo entero el primer día.</strong> Se estrena acotado, lo que llamamos el piloto, en un canal, en un horario o en un grupo de clientes, con sus categorías medidas desde la primera conversación. Ese piloto se paga y su precio entra dentro del proyecto final. Los textos delicados salen aprobados por ti antes de que nadie los lea y tu equipo sabe cómo llega un escalado y qué hacer con él.',
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              ...
              'El resto de la cuota paga la vigilancia. Una vez por semana lanzamos una conversación de prueba anonimizada contra el sistema vivo de principio a fin, por unos cinco céntimos. Y antes de publicar cualquier cambio tiene que pasar la batería de pruebas. Son dos cosas distintas y separadas a propósito. La batería frena los cambios, la prueba semanal vigila lo que ya está funcionando.',
            ],
      ...
      compliance: {
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              ...
              'La minimización deja de ser una línea de una política y pasa a ser una pregunta sobre el contexto. Un modelo de lenguaje solo puede filtrar lo que le dieron, así que el control real es qué entra en la petición. La limitación de finalidad, que es un deber tuyo y no del agente, pasa a ser algo verificable. Un agente que solo puede llamar a tres funciones aprobadas no tiene camino técnico para desviarse de su finalidad, así que la arquitectura no garantiza la limitación pero sí permite demostrarla. Y la responsabilidad proactiva pasa a ser una pregunta sobre registros. Si el sistema no puede enseñar por qué hizo lo que hizo, ningún documento de política lo va a enseñar tampoco.',
              '<strong>Por eso decimos que el papeleo sigue a la arquitectura y no al revés.</strong> Un sistema bien construido hace que el contrato de encargo, la evaluación de impacto y el registro de actividades de tratamiento se escriban antes y se defiendan mejor, porque cada afirmación de esos documentos señala algo que existe de verdad en el código. Al revés no funciona. Ninguna cantidad de documentación convierte en capaz de rendir cuentas un sistema que no lo es.',
            ],
          },
          {
          ...
          },
          {
            ...
            paragraphs: [
              '<strong>La infraestructura corre en una cuenta en la nube que es tuya, no nuestra.</strong> El repositorio está a tu nombre desde el primer día. No alojamos tu asistente de nuestro lado para darte luego un usuario. Es poco habitual en el sector y es a propósito, porque quita de golpe toda una familia de preguntas que tu DPD tendría que ir persiguiendo. No hay una base de datos nuestra con una copia de tus registros ni una negociación de salida si dejamos de trabajar juntos. El sistema se queda donde siempre estuvo, con su documentación y su historia.',
          ...
          },
          {
            ...
            part: 'Dónde van tus datos',
            paragraphs: [
              'La soberanía del dato se usa como palabra de marketing, así que conviene concretarla. Significa que la ubicación de tus datos, las claves que los abren y el sistema de identidad que dice quién es quién responden ante ti. La jurisdicción es otra cosa y esto no la resuelve. Una cuenta propia dentro de una nube estadounidense sigue teniendo detrás a una empresa estadounidense, con las leyes de su país. Por eso la palabra soberanía se usa con más alegría de la que aguanta. La ubicación sola no te lleva ahí. Un sistema cuyos datos están en Frankfurt pero cuyas claves de acceso, cuentas de administración y registros pertenecen a un proveedor es soberano en el folleto y en ningún otro sitio.',
              'Hay un abanico. Contarlo entero vale más que un eslogan. En un extremo está el software compartido, donde tus datos viven dentro del producto de otro bajo sus condiciones. Después viene correr en una región europea de una nube grande, luego una cuenta propia dentro de esa nube y por último tus propios servidores en tu propio edificio. Cada escalón compra control y cuesta comodidad. Nosotros construimos por defecto en el tercero, tu propia cuenta en la nube, porque da el control que importa, la propiedad del dato y el control de las claves y de la identidad, sin pedirle a tu equipo que administre máquinas físicas.',
              '<strong>Y ahora el párrafo que casi todos los proveedores se saltan.</strong> La aplicación que construimos corre entera dentro de infraestructura tuya. El modelo de lenguaje normalmente no, porque lo llamamos como servicio al proveedor que tú apruebes. Ejecutar un modelo abierto sobre tu propio hardware cerraría ese último hueco. Es otro proyecto, con otros costes y otro equilibrio de calidad. Si necesitas que hasta el modelo corra en tus instalaciones, dilo en la primera conversación, porque cambia la arquitectura desde los cimientos.',
          ...
          },
          {
            ...
            part: 'Cómo se garantiza el aislamiento',
            paragraphs: [
              'Las capas de seguridad están bien, pero cambiar el diseño para que el fallo no pueda existir está mejor. Uno de nuestros sistemas enseña la diferencia. Su aislamiento funcionaba originalmente por filtrado, con cada consulta llevando una condición que decía de qué empresa se permitían las filas. Después rehicimos el almacén de datos para que cada empresa viva en su propio esquema, su compartimento sellado dentro de la base de datos. La vista combinada las une con la empresa estampada en cada fila. Las consultas del asistente corren contra el esquema de quien pregunta, nunca contra la vista combinada, que existe para otros usos. Tras ese cambio, sumar dos empresas en una misma cifra dejó de ser un fallo que un filtro debe atrapar y pasó a ser una consulta que el asistente no puede formular.',
              'El efecto práctico se vio enseguida. Una comparación poco estricta de nombres que había sido una preocupación real de seguridad bajo el diseño por filtrado simplemente dejó de importar, porque ni siquiera una coincidencia equivocada podía cruzar la frontera de un esquema. <strong>Arreglar la arquitectura mató la clase entera de fallos, no un caso suelto.</strong> Es el nivel al que apuntamos siempre que los datos lo permiten. Es una pregunta útil para cualquier proveedor. Qué fallos son imposibles en tu diseño, en vez de cuáles se atrapan.',
            ],
          },
          {
            ...
            paragraphs: [
              ...
              'La identidad sigue la misma regla. Cuando un asistente consulta un sistema interno en nombre de alguien, lleva la credencial de esa persona, la misma que tus sistemas ya usan para saber quién pregunta. Cada llamada posterior corre con los permisos del humano, no con los permisos amplios de una cuenta de robot. Si la persona no puede abrir un registro a mano, el asistente no puede abrírselo. Buena parte de las preguntas de acceso del RGPD se simplifican ahí, porque el modelo de acceso del asistente pasa a ser el que tu empresa ya auditó. Esto vale cuando el asistente actúa por un usuario identificado. Cuando alguien escribe a un número de WhatsApp sin identificarse, como pasa en un asistente de citas, la identidad se resuelve de otra manera y lo que limita el acceso es lo poco que el sistema puede alcanzar.',
            ],
            link: {
              label: 'Por qué no nos gustan las arquitecturas agénticas',
              href: '/blog/no-me-gustan-los-agentes-de-ia',
          ...
          },
          {
            ...
            paragraphs: [
              ...
              'Cada campo sensible va cifrado por su cuenta, con AES-256-GCM, en vez de confiar en que el disco esté cifrado por debajo. La diferencia importa en la práctica. El cifrado de disco te protege si alguien se lleva el hardware, mientras que el cifrado por campo protege el dato de quien toca la base de datos sin pasar por la aplicación, que es el caso de una copia robada o de quien la administra. La aplicación tiene la clave, así que quien la opera sí ve el dato. Por eso los permisos y los registros importan tanto como el cifrado. <strong>Y el borrado está diseñado alrededor de lo que la ley exige, no alrededor de lo que parezca razonable</strong>. Wazzy retiene lo que la ley obliga a retener, ni más ni menos. Ese plazo no lo fijamos nosotros. Lo fija la clínica, que es la responsable del tratamiento, con la ley de autonomía del paciente delante, la 41/2002, que marca un mínimo de cinco años para la historia clínica y más en algunas comunidades. Una cita en un chat no es la historia clínica, que vive en el sistema de la clínica, pero la lógica es la misma. Una petición de supresión tiene que honrar al paciente sin incumplir en silencio una obligación legal de conservación, así que el sistema separa lo que se borra ahora de lo que se retiene por obligación y puede enseñar cuál es cuál.',
          ...
          },
          {
            ...
            paragraphs: [
              ...
              'Hasta la caducidad está diseñada para verse. Las credenciales temporales que demuestran quién está preguntando caducan en torno a la hora. Repetir una petición vieja con una credencial caducada produce un error claro y visible en vez de tomar prestadas credenciales más frescas en silencio. Preferimos que un sistema falle de forma ruidosa y visible a que acierte de una manera que nadie puede explicar. Un error nuevo y visible es mejor postura que un silencio cómodo.',
            ],
          },
          {
          ...
          },
          {
            ...
            part: 'Qué te llevas y qué preguntar',
            paragraphs: [
              '<strong>Un cumplimiento que era cierto el día del estreno y no se volvió a medir es un cuento</strong>. Estos sistemas cambian por debajo. Los proveedores actualizan modelos sin cambiarles el nombre, tu documentación crece y tus datos se mueven con el tiempo. Por eso hacemos dos cosas distintas. Antes de publicar cualquier cambio, una batería de pruebas, un banco de casos anotados y anonimizados que el sistema debe responder bien, frena la publicación si la calidad baja. Y una vez por semana, sobre el sistema vivo, reproducimos una conversación de prueba anonimizada de principio a fin y comprobamos qué pasó de verdad.',
              'Es la misma disciplina que caza a un modelo empeorando en silencio, aplicada a las promesas de esta página. El aislamiento, los registros y las negativas se prueban como funcionalidades, porque eso es lo que son. Cuando tu DPD pregunte en marzo si las garantías de la revisión de septiembre siguen en pie, la respuesta que vale es un resultado de pruebas, no un encogimiento de hombros.',
            ],
            link: {
        ...
        faq: [
          ...
          },
          {
            ...
            a: 'El sistema que construimos puede correr. Corre, en infraestructura tuya. El modelo es la parte que conviene decir con claridad. Llamamos a modelos como servicio a proveedores que tú apruebas, no hemos desplegado modelos abiertos en producción y no vamos a vender esa experiencia como si la tuviéramos. Plantea el requisito antes de que se presupueste nada y te diremos con claridad lo que costaría.',
          },
          {
  ...
  en: {
    ...
    pages: {
        ...
        sections: [
          {
            ...
            paragraphs: [
              ...
              'That is where it parts company with a bot. Not because one talks and the other acts, since general-purpose assistants have been calling tools for a while now. <strong>The difference is who decides the answer.</strong> A bot’s answer was written before anyone asked. An agent’s is put together at the moment of asking.',
          ...
          },
          {
            ...
            bullets: [
              '<strong>The reactive kind.</strong> Follows fixed rules and remembers nothing. A thermostat that turns the heating on when the temperature drops, and so is the bot from the section above. Cheap and predictable, but it only covers what someone anticipated, and every new situation goes back through a developer.',
              '<strong>The planning kind.</strong> Takes a goal and works out the sequence of steps itself, then redoes it when something goes sideways. Ask it for a quote and it checks the catalogue, confirms stock and raises an exception when a part is missing. <strong>This is where almost everything sold today as an AI agent belongs, ours included.</strong> More expensive to stand up, cheaper to extend.',
              '<strong>The learning kind.</strong> Improves by itself, from its own experience, with nobody touching it again. It is the one that turns up most in promises and least in production.',
            ],
          },
          {
          ...
          },
          {
            ...
            paragraphs: [
              ...
              'You will notice the same shape in all of them. <strong>There is a text somebody had to read and a piece of data or a system on the other side. When one of those halves is missing, there is almost always a cheaper way to solve it than an agent.</strong>',
            ],
            bullets: [
          ...
          },
          {
            ...
            paragraphs: [
              'None of this is plug and play. <strong>The gap between a good result and a disappointment is almost always in the scope</strong>, rather than in the model. Too broad and the system risks being mediocre at everything and earning trust for nothing. Too narrow and the wiring costs more than the work it saves. The projects that go well pick one task with a clear boundary around it, prove it, then widen it.',
          ...
          },
          {
            ...
            link: {
              label: 'Four layers between your company and the one next door',
              href: '/en/blog/four-layers-of-isolation',
            },
          },
          {
      ...
      conversational: {
        ...
        metaDescription:
          'Conversational AI agents that answer, qualify and act on the systems you already run. What we build, what it costs and when a chatbot is the wrong answer.',
        hero: {
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              ...
              'That split has a consequence you notice early. Adding a new transaction is not rewriting a whole tree, it is adding one action with its tests. And removing it removes it, with no leftovers of an old menu along the way.',
            ],
          },
          {
          ...
          },
          {
            ...
            part: 'How it works and why to trust it',
            paragraphs: [
              'Customer service is where a conversational agent pays for itself soonest. It answers the routine, qualifies the rest and escalates what needs judgment, so waiting queues turn into immediate replies. The real estate agency we work with puts the saving at over three hours a day. Each of those inquiries used to take five to ten minutes to check by hand. Their team now only books viewings. There, answering and qualifying are the same conversation, because filtering well is what leaves the team the work that brings in revenue.',
              '<strong>A good part of the value is in the hour you reply.</strong> Inquiries do not arrive only in office hours, they also arrive when the customer has the phone in their hand. The longer the reply takes, the less keen they are. An agent that answers within the minute turns that overnight trickle into next-morning appointments.',
            ],
            link: {
          ...
          },
          {
            ...
            kind: 'checklist',
            paragraphs: [
              'This is what the transaction we get asked for most looks like from the inside, a booking. Six steps. <strong>At any of them the conversation can jump to a person, with the history in front of them and leaving the same trail.</strong>',
            ],
            bullets: [
          ...
          },
          {
            ...
            part: 'How it works and why to trust it',
            paragraphs: [
              'An agent that only talks is worth little. The value is in the connections: the calendar it checks before offering a time, the CRM where it writes, the database the answer comes from. And connections bring their duty, because any external system can go down on a Tuesday at eleven.',
          ...
          },
          {
            ...
            paragraphs: [
              ...
              'And when there is no data to answer with, the agent says so and offers the way to a person. An honest “I do not know” keeps customers. A made-up answer loses them without you finding out, which is the worst way to lose them. That is why answers are measured by category, so a failure shows up in its own row instead of getting lost in an average.',
            ],
          },
          {
            ...
            paragraphs: [
              ...
              'This is not theory. Wazzy, the appointment assistant we run ourselves, works with health data every day and has carried that discipline since day one, so when a sector with compliance requirements turns up we are not starting from zero.',
            ],
          },
          {
          ...
          },
          {
            ...
            part: 'Deciding with judgment',
            paragraphs: [
              '<strong>A conversational agent does not go out to the whole world on day one.</strong> It launches bounded, what we call the pilot, on one channel, in one time slot or with one group of customers, with its categories measured from the first conversation. That pilot is paid for and its price counts toward the final project. The delicate texts come approved by you before anyone reads them, and your team knows how an escalation arrives and what to do with it.',
              'A few weeks in, the numbers tell the truth: what finishes inside the conversation, what escalates and why, and what people ask that we had not anticipated. That is what decides the expansion, category by category. It is how you grow without extending anything that has not been tested first.',
            ],
          },
          {
            heading: 'When a chatbot does not pay off',
            part: 'Deciding with judgment',
            paragraphs: [
              '<strong>Telling you so is part of the service too.</strong> If you get a handful of conversations a day, a well-written questions page and one person answering quickly come out cheaper and more human. If the answers you need are not in any system, the work that comes first is ordering that knowledge, not building the bot. And if for whatever reason your customer needs to talk to a person, what you want is for them to get there sooner, not to put a machine in the way.',
          ...
          },
          {
            ...
            part: 'Deciding with judgment',
            paragraphs: [
              'The published ranges for any agent of ours hold here, between €2,500 and €10,000 to build and between €150 and €500 a month to run. The factor particular to conversational work is volume. <strong>On WhatsApp that comes with two meters rather than one.</strong> Each conversation spends its model calls. Meta charges separately for every template delivered, which is what appointment reminders are. Both arrive itemized. Before you commission anything you will have an estimate, built from what we already measure on comparable systems and applied to your volume. The pilot turns it into a measurement with your own conversations. The full breakdown is in the cost guide.',
            ],
            link: {
              label: 'How much does an AI agent cost, broken down',
              href: '/en/ai-agent-development-cost',
        ...
        faq: [
          {
            ...
            a: 'A classic chatbot follows a script with buttons and breaks the moment you step outside it. A conversational agent understands free text and picks from the available actions, so the same question asked twenty different ways lands in the same place.',
          },
          {
