...
description: 'An entire market sells prompt engineering. Our production experience says otherwise: you gain more by organizing the data than by polishing the prompt.'
lang: 'en'
pubDate: 2026-08-11
...
## A real case: the threshold that detected nothing
...
The classic temptation would have been to touch the instructions: ask the model, with more emphasis, to recognize when there was no evidence. What worked was working the data and code layers: listening to the documentation agent's own "no match" verdict, redesigning the dispatcher to accept it, and leaving every relabeling audited. The prompt barely changed.

## Another: isolation that stopped depending on remembering
