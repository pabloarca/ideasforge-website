...
If you are evaluating an assistant that will touch real data, ask about the layers and ask what happens when the permission list arrives empty. We enjoy answering. This is how we build in [AI agent development](/en/ai-agent-development), the deeper story of data, records and sovereignty lives in [GDPR-compliant AI](/en/gdpr-compliant-ai), and both come from the same systems.
