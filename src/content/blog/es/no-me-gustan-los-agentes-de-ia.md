...
Ahora vuelve a la arquitectura agéntica típica y cuenta ingredientes. El agente tiene acceso a datos privados. Lee texto que viene de fuera. Y dispone de herramientas para actuar sobre tus sistemas. Cada uno por separado es inofensivo. Juntos abren la puerta a que un texto malicioso acabe moviendo datos que no debía, que es exactamente el riesgo que encabeza la lista de OWASP. Los dos primeros suelen ser la razón de que el sistema exista. El tercero es el que hay que recortar.
