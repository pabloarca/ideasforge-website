...
Compra seguridad demostrable, porque los permisos se aplican sobre el contrato validado y la consulta final lleva su filtro incondicional, la última de las cuatro capas que separan los datos de cada empresa de los de la de al lado. Y compra el resultado de negocio que justifica el proyecto, la espera por una cifra pasó de horas a segundos, sin abrir la puerta que el patrón ingenuo deja entornada. Cómo quedó montado por dentro, con lo que hubo que quitarle al modelo por el camino, está en [la página del caso](/casos/savian).
...
Las cifras, además, nunca salen de la memoria de la conversación. Un auditor interno fuerza una consulta fresca para cada número que se entrega.
